...
//        SendMail mail = new SendMail("operation@simplefintech.net","Yunying1");  
        SendMail mail = new SendMail("982338665@qq.com","vlytbyndrpfwbfhg");  
//        SendMail mail = new SendMail("luofengli123@163.com","qazwsx123");
