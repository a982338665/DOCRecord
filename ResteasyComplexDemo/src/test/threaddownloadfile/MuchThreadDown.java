...
//  private String path = "http://mpge.5nd.com/2016/2016-11-15/74847/1.mp3";    //下载路径
    private String path = "http://www.manyjar.com/download?storeName=m/mahout-examples/mahout-examples-0.8-job.jar";
    private String targetFilePath="C:\\Users\\cjh\\Desktop";  //下载文件存放目录
