...
public class ExcelUtils {
	...
	public static List<List<Object>> readExcel(File file) throws Exception {
		...
		System.err.println("sheet.getPhysicalNumberOfRows()"+sheet.getPhysicalNumberOfRows());
		System.err.println("sheet.getPhysicalNumberOfRows()"+sheet.getPhysicalNumberOfRows());
		for (int i = (sheet.getFirstRowNum() + 1); i <= (sheet
			...
			System.err.println("row.getFirstCellNum()"+ row.getFirstCellNum());
			System.err.println("row.getLastCellNum()"+row.getLastCellNum());
			System.err.println("row.getPhysicalNumberOfCells()"+row.getPhysicalNumberOfCells());
...
//				for (int j = row.getFirstCellNum(); j <= row.getLastCellNum(); j++) {
				...
				case XSSFCell.CELL_TYPE_NUMERIC:
					// 日期数据返回LONG类型的时间戳
					if ("yyyy\"年\"m\"月\"d\"日\";@".equals(cell.getCellStyle()
							.getDataFormatString())) {
...
//				}
	 ...
	 * @throws Exception
	 */
	public static List<List<Object>> readExcel(FileInputStream fileInputStream)
			throws Exception {
		List<List<Object>> list = new LinkedList<List<Object>>();
	...
	public static void main(String[] args) {
		File file=new File("C:/Users/cjh/Desktop/allstudents.xlsx");
		try {
